...
/**
 * Base class that represents a query for the 'shortcode' table.
 *
 *
 *
...
abstract class ShortcodeQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, TAG, EVENT, ACTIVE, CREATED_AT, UPDATED_AT FROM shortcode WHERE ID = :p0';
        try {
    ...
    /**
     * Deletes all rows from the shortcode table.
     *
